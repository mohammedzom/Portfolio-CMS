...
<body class="h-full antialiased text-slate-900" x-data="{ sidebarOpen: false }">
    <div class="min-h-full">
        ...
        <!-- Sidebar for Desktop -->
        <div
            class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col lg:border-r lg:border-slate-200 lg:bg-white">
            @include('partials.admin.sidebar')
        </div>
        ...
        <div class="lg:pl-72">
            <!-- Header -->
            <header
                class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-slate-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 items-center justify-between">
                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        <a href="{{ route('home') }}" target="_blank"
                            class="text-sm font-medium text-slate-600 hover:text-indigo-600 flex items-center gap-1 transition-colors">
            ...
            <main class="py-10">
                <div class="px-4 sm:px-6 lg:px-8">
                    @if (session('success'))
                        <div
                            class="mb-8 rounded-xl bg-emerald-50 p-4 border border-emerald-100 flex items-center gap-3 text-emerald-800 animate-fade-in">
