...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <form action="{{ route('admin.skills.store') }}" method="POST" class="p-8 space-y-6">
            @csrf

            <x-admin.input label="Skill Name" name="name" placeholder="PHP, React, UI Design..." required="true" :error="$errors->first('name')" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5" x-data="{ proficiency: {{ old('proficiency', 80) }} }">
            ...
            <x-admin.input label="Icon URL or Class" name="icon" placeholder="ri-code-line or https://..." :error="$errors->first('icon')" />
