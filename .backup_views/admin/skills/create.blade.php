...
@section('page-subtitle', 'Create a new technical skill')
...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <div class="glass rounded-2xl border border-dark-700 p-6">
            <form action="{{ route('admin.skills.store') }}" method="POST" x-data="{ 
                proficiency: 50,
                type: 'Frontend',
                color: '#06b6d4'
            }">
                ...
                <div class="space-y-6">
                        ...
                        <div class="grid sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <select name="type" id="type" x-model="type" required
                                    ...
                                    <option value="Full Stack" {{ old('type') == 'Full Stack' ? 'selected' : '' }}>Full Stack</option>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="url" name="icon" id="icon" value="{{ old('icon') }}"
                    ...
                    <div class="flex items-center gap-4 pt-6 border-t border-dark-700">
                        <button type="submit"
                            ...
                            <i class="ri-save-3-line"></i> Create Skill
                        </button>
                        <a href="{{ route('admin.skills.index') }}"
...
<script>
    ...
    document.getElementById('icon')?.addEventListener('input', function(e) {
        const img = e.target.closest('.glass').querySelector('img');
